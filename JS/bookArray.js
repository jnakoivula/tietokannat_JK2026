...
//Tulostaa tietotyypin
console.log(typeof bookArray);
//Tulostaa koko sisällön
console.log(bookArray);
//tulostaa ensimmäisen rivin
console.log(bookArray[0]);
//tulostaa ensimmäisen kirjan nimen
console.log(bookArray[0].name);
//tulostaa rivien määrän
console.log(bookArray.length);
//tulostaa kaikkien kirjojen nimet:
