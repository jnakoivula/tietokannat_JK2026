...
//tulostaa annetun kirjan tiedot
getOneBook: function(x) {
    console.log(this.bookArray[x]);
},

//lisää annetun kirjan
...
book.getAllBooks();
book.getOneBook(1);
book.addBook(16, "Lord of the Rings", "Tolkien", "9780544003415");
//Tarkistetaan vielä että kirja lisättiin oikein
book.getAllBooks();